...
class Person {
    ...
    */
    public void tampilListRekeningBank() {
        ...
        //Implementation @mjulianfr
        for (int i = 0; i < akunBank.size(); i++) {
            BankAccount tmp_b = akunBank.get(i);
...
class Bank {
    ...
    */     
    public String generateNoRek() {
        ...
        StringBuilder str = new StringBuilder(kodeBank);
        str.append(randomNum);
        //=========================================================
        return str.toString(); // ubah returnnya
    }
}
