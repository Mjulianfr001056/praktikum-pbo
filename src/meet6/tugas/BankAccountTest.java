            ...
            switch(menu) {
                ...
                case "6" -> {
                    try {
                        ...
                        System.out.println(String.format(" (Pengirim) Saldo akhir objek %s no.rek %s Bank %s adalah %.2f",
                                p.get(i-1).getNama(),
                                noRek,
                                p.get(i-1).getAkunBank(noRek).getBank(),
                                p.get(i-1).getAkunBank(noRek).getSaldo()
                        ));
                        System.out.println(String.format(" (Penerima) Saldo akhir objek %s no.rek %s Bank %s adalah %.2f",
                                p.get(x-1).getNama(),
                                noRekPenerima,
                ...
                case "7" -> {
                    for (int i=0;i<p.size();i++) {
                        System.out.println(String.format("%d. [nama: %s] [umur: %d] [total saldo semua bank : Rp. %.2f]",
                                i+1,
                                p.get(i).getNama(),
                                p.get(i).getUmur(),
