...
public class StrategyTest {
    public static void main(String[] args) {
        ...
        /*Jadi prinsip dari OCP ttp terpakai karena saat menambah rute, tidak perlu mengedit
          Class route, tinggal buat sebuah kelas yang meng-implements Routable. Klo mau nambah
          class concrete juga bisa, bikin aja sebuah kelas yang meng-extends dari Route, misal
          PublicTransporting, ntar dalemnya ada method untuk mengcomposisi usedRoute dengan Boarding.
